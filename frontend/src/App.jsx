      ...
      <section className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200">
        <div className="space-y-4">
          ...
          <button onClick={handleConnect} disabled={loadingFiles || !repoUrl}
            ...
            <a href="https://github.com/apps/TU-APP-NAME/installations/new" target="_blank" rel="noopener noreferrer" className="w-full py-3 flex items-center justify-center gap-2 rounded-xl border border-slate-200 bg-slate-50 hover:bg-slate-100 text-slate-600 font-bold text-base transition-all">
              <Github size={16} />
                Instalar GitHub App
            </a>
